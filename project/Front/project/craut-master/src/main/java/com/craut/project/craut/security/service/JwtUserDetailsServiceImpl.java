...
public class JwtUserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        UserEntity user = (UserEntity)genericDaoImpl.findByParametr(username,"UserEntity","email");
        UserRoleEntity userRoleEntity = (UserRoleEntity)genericDaoImpl.findById(new UserRoleEntity(),user.getIduser());
